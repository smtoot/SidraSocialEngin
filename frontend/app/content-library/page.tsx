...
const ContentLibraryPage: React.FC = () => {
  ...
  useEffect(() => {
    const fetchLibrary = async () => {
      try {
        const res = await api.get<{ data: ContentCard[] }>('/api/content/library');
